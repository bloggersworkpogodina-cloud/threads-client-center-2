...
def admin_menu():
    return ReplyKeyboardMarkup(keyboard=[[KeyboardButton(text="👥 Клиенты"), KeyboardButton(text="➕ Добавить клиента")], [KeyboardButton(text="📊 Аналитика"), KeyboardButton(text="🗂 Архив")], [KeyboardButton(text="🗓 План понедельника")], [KeyboardButton(text="📣 Сообщение всем")]], resize_keyboard=True)
